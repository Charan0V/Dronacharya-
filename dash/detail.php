...
<body class="bg-light" style="background: linear-gradient(180deg,#f5e6c9 0%, #efdfbf 45%, #e0cfa6 100%); color:#3b2f1c;">
  <nav class="navbar navbar-expand-lg bg-white/70 shadow-sm" style="backdrop-filter: blur(6px);">
    <div class="container">
      <a class="navbar-brand fw-bold" href="dashboard.php" style="font-family: 'Cinzel', serif; color:#b58900;">Roadmap</a>
      <div class="ms-auto">
  ...
  <main class="container py-4">
    ...
    <?php else: ?>
      <div class="card shadow-sm fade-in" style="border:1px solid rgba(79,50,21,.25); background:rgba(255,253,246,.85);">
        <div class="card-body">
          <h1 class="h4 mb-3" style="font-family: 'Cinzel', serif; color:#8a6a28; "><?php echo htmlspecialchars($item[0] ?? ''); ?></h1>
